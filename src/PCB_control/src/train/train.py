...
parser.add_argument('---training-steps', type=int, default=30000)
parser.add_argument('---resume-path', type=str, default='./ckpt/init_local_2.ckpt')
parser.add_argument('---logdir', type=str, default='./train_results/local_2')
...
def main():
    ...
    trainer = pl.Trainer(accelerator="gpu", devices=[0,1,2,3], strategy="ddp_find_unused_parameters_true",
                         precision=32,
